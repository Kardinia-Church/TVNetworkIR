...
//IR commands
#define POWER_TOGGLE_IR 0xFDB04F        //The power on IR value to send to toggle the power
#define POWER_TIMEOUT_SEC 5            //The timeout between power sends (this is to stop commands being sent while a tv is booting)